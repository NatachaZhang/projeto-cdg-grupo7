...
O número de agrupamentos (_clusters_) não foi definido à partida, o modelo _Agglomerative Clustering_ foi executado com os parâmetros por defeito e avaliado através de três métricas de _clustering_: _Silhouette Score_, _Calinski-Harabasz_ e _Davies-Bouldin_.
